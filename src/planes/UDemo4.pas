...
procedure TForm101.AdvVerticalPolyList2ItemSelect(Sender: TObject;
...
procedure TForm101.CheckItem1ItemClick(Sender: TObject; Item: TCustomItem);
begin
...
procedure TForm101.HTMLItem1CaptionAnchorClick(Sender: TObject; Anchor: string);
begin
  ShellExecute(Handle, 'Open', PChar(Anchor), nil, nil, SW_SHOWNORMAL);
  Memo1.Lines.Add('Click on Anchor : ' + Anchor);
end;

procedure TForm101.ImageItem10ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' Clicked');
end;

procedure TForm101.ImageItem1ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' Clicked');
end;

procedure TForm101.ImageTextButtonItem1ItemButtonClick(Sender: TObject;
  Item: TCustomItem);
begin
  if item.Tag = 0 then
  begin
...
procedure TForm101.ImageTextItem10ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' clicked');
end;

procedure TForm101.ImageTextItem1ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' Clicked');
  case item.Index of
    9:
...
procedure TForm101.LargeButtonedItem1ItemButtonClick(Sender: TObject;
  Item: TCustomItem);
begin
  Memo1.Lines.Add(TLargeButtonedItem(Item).ButtonCaption + ' Clicked');
end;

procedure TForm101.LargeButtonedItem4ItemButtonClick(Sender: TObject;
  Item: TCustomItem);
begin
  Memo1.Lines.Add(TLargeButtonedItem(Item).ButtonCaption + ' Clicked with copies : ' + inttostr(SpinEdit1.Value));
end;

procedure TForm101.RadioItem1DrawGraphic(Sender: TObject; g: TGPGraphics;
  Rect: TGPRectF; Item: TCustomItem; Checked: Boolean; State: TGraphicState;
  Kind: TGraphicKind; Enabled: Boolean; var Default: Boolean);
var
  b: TGPBrush;
...
procedure TForm101.ShowPage(Item: integer);
begin
  HidePages;
