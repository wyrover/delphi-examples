...
uses
  ...
  Graphics, Controls, Forms, Dialogs, AdvGauge, ComCtrls, StdCtrls,
  AdvGDIPicture, AdvGDIP, ExtCtrls, AdvGaugeCircle, AdvRangeCircles;
...
procedure TForm94.AdvGaugeCircle1ClickDown(Sender: TObject);
begin
  //ShowMessage('down clicked');
end;

procedure TForm94.AdvGaugeCircle1ClickUp(Sender: TObject);
begin
...
procedure TForm94.CheckBox1Click(Sender: TObject);
begin
...
procedure TForm94.CheckBox2Click(Sender: TObject);
begin
  AdvGauge1.UseSplitPosition := (Sender as TCheckBox).Checked;
end;

procedure TForm94.CheckBox3Click(Sender: TObject);
begin
  AdvGauge1.IsRange := (Sender as TCheckBox).Checked;
end;

procedure TForm94.CheckBox4Click(Sender: TObject);
begin
  if (Sender as TCheckBox).Checked then
...
begin
  case ComboBox1.ItemIndex of
    0:
      AdvGauge1.Kind := gkMinmax;
    1:
      AdvGauge1.Kind := gkNightday;
    2:
      AdvGauge1.Kind := gkBattery;
    3:
      AdvGauge1.Kind := gkText;
    4:
      AdvGauge1.Kind := gkNone;
  end;
end;

procedure TForm94.ComboBox2Change(Sender: TObject);
begin
  case ComboBox2.ItemIndex of
    0:
      AdvGauge1.TextPosition := tpNone;
    1:
      AdvGauge1.TextPosition := tpInNeedle;
    2:
      AdvGauge1.TextPosition := AdvGauge.tpTop;
    3:
      AdvGauge1.TextPosition := AdvGauge.tpBottom;
  end;
end;

procedure TForm94.Edit1Change(Sender: TObject);
begin
  AdvGauge1.MinText := Edit1.Text;
end;

procedure TForm94.Edit2Change(Sender: TObject);
begin
...
procedure TForm94.TrackBar1Change(Sender: TObject);
var
  I: Integer;
begin
